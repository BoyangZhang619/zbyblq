...
import { CategoryManager } from '@/composable/pages/CategoryManager'
import { ToolListManager } from '@/composable/pages/ToolListManager'
...
<style scoped>
@import '@/css/views/sort.css';
@import '@/css/views/toolList.css';
</style>